...
public class Consulta {
  ...
  @ApiModelProperty(example = "HIDALGO 32", value = "Se presentará la Dirección de la Institución Otorgante que reporta la cuenta.")
  ...
  @ApiModelProperty(example = "5512345678", value = "Se presentará el teléfono de la Institución Otorgante que reporta la cuenta.")
